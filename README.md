...
5. The score model: First we multiply your BCH score with a 1 when you have a Badge on the scoreboard, with 2 if you enabled the Push & PR and with 3 if you have a Badge on the scoreboard, enabled Push & PR *and* have test code. Then we devide by 10. The final score will between 0 and 3.0 
